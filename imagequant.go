...
#cgo windows,386 LDFLAGS: -Llibs/windows/386 -limagequant -ldl -lm
...
#cgo darwin,amd64 LDFLAGS: -Llibs/darwin/amd64 -limagequant -ldl -lm
#cgo darwin,arm64 LDFLAGS: -Llibs/darwin/arm64 -limagequant -ldl -lm
